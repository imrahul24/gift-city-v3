    ...
    <header className="topbar-line relative flex items-center gap-3 lg:gap-5 px-4 lg:px-6 z-30 flex-shrink-0 transition-colors duration-300"
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        <div className="flex items-center justify-center flex-shrink-0"
          style={{ width:42, height:42, borderRadius:10, background: dark ? '#1a1d2a' : '#f0f1f7', padding:4 }}>
          <img src={logo} alt="GIFT City" style={{ width:'100%', height:'100%', objectFit:'contain' }} />
        </div>
